...
INSERT INTO cma.members (id, name, email, phone, interests, preferred_channel, engagement_score, tier, joined_at, last_active_at) VALUES
...
INSERT INTO cma.events (id, title, description, event_date, location, type, capacity, status) VALUES
...
INSERT INTO cma.rsvps (member_id, event_id, status, registered_at, confirmed_at) VALUES

-- Gita Jnana Yajna (e1) — 13 RSVPs
...
INSERT INTO cma.agent_messages (agent_type, member_id, event_id, channel, direction, subject, content, status, sent_at, responded_at) VALUES
